              ...
              <div className="accordion-item mb-3">
                <h2 className="h5 px-4 py-3 accordion-header d-flex justify-content-between align-items-center">
                  <div className="form-check w-100 collapsed" data-bs-toggle="collapse" data-bs-target="#collapseCC" aria-expanded="false">
                    <input onClick={() => paymentMethodSelectHandler("cc")} className="form-check-input" type="radio" name="payment" id="payment1" />
                ...
                <div id="collapseCC" className={ccStyle} data-bs-parent="#accordionPayment">
                  <div className="accordion-body">
                    <div className="mb-3">
                      <label className="form-label">Card Number</label>
                      <input onChange={(e) => setCcNumber(e.target.value)} type="text" className="form-control" placeholder="" />
                    </div>
                    <div className="row">
                      <div className="col-lg-6">
                        <div className="mb-3">
                          <label className="form-label">Name on card</label>
                          <input onChange={(e) => setCcName(e.target.value)} type="text" className="form-control" placeholder="" />
                        </div>
                      </div>
                      <div className="col-lg-3">
                        <div className="mb-3">
                          <label className="form-label">Expiry date</label>
                          <input onChange={(e) => setCcExp(e.target.value)} type="text" className="form-control" placeholder="MM/YY" />
                        </div>
                      </div>
                      <div className="col-lg-3">
                        <div className="mb-3">
                          <label className="form-label">CVV Code</label>
                          <input onChange={(e) => setCcCvv(e.target.value)} type="password" className="form-control" />
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="accordion-item mb-3 border">
                <h2 className="h5 px-4 py-3 accordion-header d-flex justify-content-between align-items-center">
                  <div className="form-check w-100 collapsed" data-bs-toggle="collapse" data-bs-target="#collapsePP" aria-expanded="false">
                    <input onClick={() => paymentMethodSelectHandler("pp")} className="form-check-input" type="radio" name="payment" id="payment2" />
                ...
                <div id="collapsePP" className={ppStyle} data-bs-parent="#accordionPayment" >
                  <div className="accordion-body">
                    <div className="px-2 col-lg-6 mb-3">
                      <label className="form-label">Email address</label>
                      <input onChange={(e) => setPpEmail(e.target.value)} type="email" className="form-control" />
                    </div>
                  </div>
                </div>
              </div>
